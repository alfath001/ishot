...
<head>
	...
	<title>Business IT Case Comp</title>
	...
	<nav class="navbar navbar-default navbar-fixed-top" data-spy="affix" data-offset-top="400">
		<div class="container" style="">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<li class="dropdown">
							...
							background: linear-gradient(to bottom right, #FB4D80, #F66930); /* Standard syntax */ border-radius: 30px;" data-toggle="modal" data-target="#login-modal"><a href="#" style="color: #fafafa; width: 100px; height: 40px;
				...
				<div class="modal-dialog">
					<div class="loginmodal-container">
						...
						<form method="POST" role="form" action="{{ route('regis.custom') }}">
							...
							NIM Ketua <input type="text" name="nim" placeholder="Input NIM Ketua">
			...
			<div class="col-md-12 col-xs-12 col-sm-12" id="box-image1">
				<img src="seminarfix/ss3.png" alt="" id="image1" class="hidden-xs">
			</div>
			<div class="col-md-12 col-xs-12 col-sm-12" align="center" id="content1">
				...
				<h1 class="wow fadeInDown">Business Skills</h1>
				<h1 class="wow fadeInDown">Make World Better</h1>
				<h4 class="wow fadeInUp">Create Your Own Business</h4>
				<h4 class="wow fadeInUp">And Make It Happen</h4>
				...
				<br>
				<br>
				<a href="http://bit.ly/RULEBOOK-BUSINESSITCASE-2017">
			...
			<div class="col-md-12 col-xs-12 col-sm-12" id="sec3" data-offset-top="1200">
				<div class="col-md-6 col-sm-6 wow slideInLeft" align="center" id="gambar2">
					<img src="assets/img/business-card.png" alt="">
				</div>
				<div class="col-md-6 col-sm-6 wow zoomInLeft" id="box-cap3" data-offset-top="1200">
					...
					<div class="col-md-12 col-xs-12 col-sm-12" id="cap3">
						...
						<div class="col-md-11 col-xs-10" id="desc3">
							<p>Mendaftar pada halaman website www.ishot.kbmsi.or.id/itcase</p>
						</div>
					</div>
					...
					<div class="col-md-12 col-xs-12" id="cap3">
						...
						<div class="col-md-11 col-xs-10" id="desc3">
							<p>Selamat tim anda berhasil menjadi peserta dari Business Case IT Competition</p>
						</div>
					</div>
					<div class="col-md-12 col-xs-12" id="cap3">
						<div class="col-md-1 col-xs-2">
						...
						<div class="col-md-11 col-xs-10" id="desc3">
							<p>Untuk info lebih lanjut dapat mendownload Rulebook <a href="http://bit.ly/RULEBOOK-BUSINESSITCASE-2017">disini</a></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-12 col-sm-12" id="sp">
					<div class="container">
						...
						<div class="col-md-12 col-sm-12" id="box-card" data-offset-top="1700">
							...
							<ul>
								<li><p>Setiap tim terdiri dari 2-3 orang Mahasiswa S1 Program Studi Sistem Informasi Fakultas Ilmu Komputer Universitas Brawijaya</p></li>
								<li><p>Setiap Peserta hanya boleh terdaftar dalam satu tim</p></li>
								<li><p>Peserta tidak akan mengalami perubahan status Mahasiswa sampai babak final kompetisi ISHOT</p></li>
								<li><p>Membayar biaya pendaftaran sebesar Rp 50.000,- per tim</p></li>
								<li><p>Pendaftaran melalui website www.ishot.kbmsi.or.id/itcase</p></li>
							</ul>
							<br><br>
						</div>
					</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12" id="box-tl2">
									<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" >
										<center>
											...
											<p id="tgl-button1">20/10/2017 <br> - <br> 26/10/2017</p>
									...
									<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button">
										<center>
											...
											<p id="tgl-button2">28/10/2017 <br> - <br> 08/11/2017</p>
											<p id="capt-button2" style="margin-left: -30px;">Pengerjaan Proposal</p>
										</center>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button">
										<center>
											...
											<p id="tgl-button3">08/11/2017</p>
											<p id="capt-button3" style="margin-left: -50px;">Deadline Submit Proposal</p>
										</center>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button">
										<center>
											...
											<p id="tgl-button4" style="margin-left: 40px; margin-top:0px;">16/11/2017</p>
											<p id="capt-button4" style="margin-left: 0px;">Pengumuman<br> Final</p>
										</center>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12" id="box-tl2" style="">
									<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
										<center>
											...
											<div class="button-garis"></div>
											<p id="tgl-button1">17/11/2017</p>
											<p id="capt-button1" style="margin-left:-20px;">Technical Meeting</p>
										</center>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button">
										<center>
											...
											<p id="tgl-button2">18/11/2017</p>
											<p id="capt-button2" style="padding-left: 20px;">Final</p>
										</center>
									</div>
								</div>
							</div>
...
<!-- 	<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs" id="bagian-timeline" style="background: #DA22FF;
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 visible-lg" id="kotak-arrow-left" style="">
			<a class="left carousel-control" href="#myCarousel" data-slide="prev">
				<span class="glyphicon glyphicon-chevron-left" id="arrow-left" style=""></span>
				<span class="sr-only">Previous</span>
			</a>
					...
					<div class="col-lg-12 col-md-12 col-sm-12" id="box-tl1" style="">
						<div class="col-lg-12 col-md-12 col-sm-12" id="box-tl2" style="">
							<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
								<center>
									<button class="btn btn-info" id="button-left" style="">
										<img src="img/attach.png" alt="" class="img-responsive" id="circle-one">
									</button>
									<div class="button-garis"></div>
									<p id="tgl-button1">20/10/2017 <br> - <br> 26/10/2017</p>
									<p id="capt-button1">Registration</p>
							...
							<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
								<center>
									<button class="btn btn-info" id="button-mid1" style="">
										<img src="img/tap.png" alt="" class="img-responsive" id="circle-one">
									</button>
									<div class="button-garis2"></div>
									<p id="tgl-button2" >28/10/2017 <br> - <br> 08/11/2017</p>
									<p id="capt-button2" style="margin-left: -40px;">Pengerjaan Proposal</p>
								</center>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
								<center>
									<button class="btn btn-info" id="button-mid2" style="">
										<img src="img/search.png" alt="" class="img-responsive" id="circle-one">
									</button>
									<div class="button-garis3"></div>
									<p id="tgl-button2" style="margin-left: 20px; margin-top: 40px;">08/11/2017</p>
									<p id="capt-button2" style="margin-left: -30px;">Deadline Submit<br> Proposal</p>
								</center>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
								<center>
									<button class="btn btn-info" id="button-right" style="">
										<img src="img/promotion.png" alt="" class="img-responsive" id="circle-one">
									</button>
									<p id="tgl-button2" style="margin-left :45px; margin-top: 40px;">16/11/2017</p>
									<p id="capt-button2" style="">Pengumuman<br> Final</p>
								</center>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12" id="box-tl2" style="">
							<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
								<center>
									...
									<div class="button-garis"></div>
									<p id="tgl-button1">17/11/2017</p>
									<p id="capt-button1" style="margin-left: -25px;">Technical Meeting</p>
								</center>
							</div>
							...
							<div class="col-lg-3 col-md-3 col-sm-3" id="kotak-button" style="">
								<center>
									...
									<p id="tgl-button2">18/11/2017</p>
									<p id="capt-button2" style="margin-left: 15px;">Final</p>
								</center>
							</div>
						</div>
					</div>
			...
			<div class="item active">
				<div class="col-xs-12" id="box-button-xs">
					<center>
						...
						<p id="tgl-xs">20/10/2017 - 26/10/2017</p>
					</center>
				</div>
			</div>
			...
			<div class="item">
				<div class="col-xs-12" id="box-button-xs">
					<center>
						...
						<p id="capt-xs">Pembagian Case</p>
						<p id="tgl-xs">28/10/2017</p>
					</center>
				</div>
			</div>
			...
			<div class="item">
				<div class="col-xs-12" id="box-button-xs">
					<center>
						...
						<p id="capt-xs">Pengerjaan Proposal</p>
						<p id="tgl-xs">28/11/2017 - 08/11/2017</p>
					</center>
				</div>
			</div>
			...
			<div class="item">
				<div class="col-xs-12" id="box-button-xs">
					<center>
						...
						<p id="capt-xs">Deadline Submit Proposal</p>
						<p id="tgl-xs">08/11/2017</p>
					</center>
				</div>
			</div>
			<div class="item">
				<div class="col-xs-12" id="box-button-xs">
					<center>
						...
						<p id="capt-xs">Pengumuman Final</p>
						<p id="tgl-xs">16/11/2017</p>
					</center>
				</div>
			</div>
			<div class="item">
	...
	<div class="container">
		<div class="col-md-12 col-sm-6">
				<div class="col-md-6" id="box-sponsor">
					{{-- <h2>Sponsored by</h2> 
					<hr class="garis-sponsor" style="margin-left: 0px;"> 
