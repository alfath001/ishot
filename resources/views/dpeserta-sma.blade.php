...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Peserta SMA</h1>
                </div>
                <!-- /.col-lg-12 -->
                
                <a href="{{ route('dpeserta.kbmsi') }}" class="btn btn-primary">Peserta KBMSI</a>
                <br><br>
                                 ...
                                 @foreach ($pesertas as $peserta)
                                   @if(!$peserta->admin)
                                    <tr class="odd gradeX text-center">
                                        <td class="center">{{ $peserta->nama }}</td>
                                        <td class="center">{{ $peserta->namaTeam }}</td>
                                        <td class="center">{{ $peserta->email }}</td>
                                        <td class="center">{{ $peserta->noTelp }}</td>
                                        <td class="center">{{ $peserta->idLine }}</td>
                                        <td class="center">{{ $peserta->sekolah }}</td>
                                    </tr>
                                   @endif
                                 @endforeach    
                                </tbody>
